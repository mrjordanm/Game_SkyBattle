...
from code.Const import SCORE_POS, MENU_OPTION, C_WHITE, C_CYAN, C_RED, C_BLUE2, C_BLUE1, C_YELLOW, WIN_WIDTH, WIN_HEIGHT
from code.DBProxy import DBProxy

class Score:
    def __init__(self, window):
        self.window = window
        self.surf = pygame.image.load('./asset/ScoreBg.png').convert_alpha() # background
    ...
    def save(self, game_mode: str, player_score: list[int]):
        ...
        while True:
            ...
            self.score_text(55, 'YOU WIN! :)', C_CYAN, SCORE_POS['Title'])
            ...
            self.score_text(18, text, C_WHITE, SCORE_POS['EnterName'])
    ...
    def show(self):
        ...
        pygame.mixer_music.play(-1) # loop
        self.window.blit(source=self.surf, dest=self.rect)
        self.score_text(50, 'TOP 10 SCORE', C_BLUE1, SCORE_POS['TitleScore'])
